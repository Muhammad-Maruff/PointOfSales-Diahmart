...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var alertStatus = (_document$querySelect = document.querySelector('meta[name="alert-status"]')) === null || _document$querySelect === void 0 ? void 0 : _document$querySelect.content;
  var alertMessage = (_document$querySelect2 = document.querySelector('meta[name="alert-message"]')) === null || _document$querySelect2 === void 0 ? void 0 : _document$querySelect2.content;
...
function createShapes() {
  var shapes = document.querySelector('.floating-shapes');
  var shapeCount = 15;
  for (var i = 0; i < shapeCount; i++) {
    ...
    shape.style.left = "".concat(randomPosition.left, "%");
    shape.style.top = "".concat(randomPosition.top, "%");
    shape.style.width = "".concat(randomPosition.size, "px");
    shape.style.height = "".concat(randomPosition.size, "px");
    shape.style.animationDelay = "".concat(Math.random() * 20, "s");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var searchInput = document.querySelector('[data-search-user]');
  if (searchInput) {
    searchInput.addEventListener('keyup', function (e) {
      var searchTerm = e.target.value.toLowerCase();
      var userCards = document.querySelectorAll('.card');
      userCards.forEach(function (card) {
        var userName = card.querySelector('h3').textContent.toLowerCase();
        var userRole = card.querySelector('.text-muted').textContent.toLowerCase();
  ...
  document.getElementById('form-user').addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var formData, response, data, errorMessage;
        ...
        while (1) switch (_context.prev = _context.next) {
          ...
          case 14:
            ...
            Object.values(data.errors).forEach(function (error) {
              errorMessage += "<li>".concat(error, "</li>");
            });
            errorMessage += '</ul>';
            Swal.fire({
              icon: 'error',
